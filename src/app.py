...
activities = {
    ...
    "Soccer Team": {
        "description": "Team soccer practices and competitions",
    ...
    "Art Club": {
        "description": "Explore painting, drawing, and creative media",
    ...
    "Robotics Club": {
        "description": "Design and build robots for school contests",
